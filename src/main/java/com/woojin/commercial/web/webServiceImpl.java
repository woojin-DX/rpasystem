...
public class webServiceImpl implements webService {
	...
	@Override
    public Map<String, Object> listweb(CommandMap commandMap)  throws Exception {
        ...
        try {
            ...
            Map<String, Object> dataMaterialMap =  webDAO.listMaterialNum(commandMap.getMap());
            ...
            dataMap =  webDAO.listweb(commandMap.getMap());
            List<webVO> listParam = (List<webVO>) dataMap.get("datalist");
            ...
            resultMap.put("webList", listParam); //목록
        }
        catch(Exception e){
	...
	@Override
    public Map<String, Object> listwebConfirm(CommandMap commandMap)  throws Exception {
        Map<String, Object> resultMap = new HashMap<String,Object>();
        try {
            ...
            if (commandMap.get("web_month") == null) {
                String firstDate = formatter.format(cal.getTime());
                commandMap.put("web_month", firstDate);
            }
            Map<String, Object> dataMaterialMap =  webDAO.listMaterialOrderAll(commandMap.getMap());
            List<MeterialNumVO> listMaterialParam = (List<MeterialNumVO>) dataMaterialMap.get("materiallist");

            dataMap =  webDAO.listwebConfirm(commandMap.getMap());
            List<webVO> listParam = (List<webVO>) dataMap.get("datalist");
    ...
    @SuppressWarnings("unchecked")
	@Override
    public Map<String, Object> listwebResheet(CommandMap commandMap)  throws Exception {
        Map<String, Object> resultMap = new HashMap<String,Object>();
        try {
            SimpleDateFormat formatter = new SimpleDateFormat("yyyy.MM", Locale.KOREA);
            Calendar cal = Calendar.getInstance();
            ...
            dataMap =  webDAO.listwebResheet(commandMap.getMap());
            List<webVO> listParam = (List<webVO>) dataMap.get("datalist");
    ...
    @SuppressWarnings({ "unchecked", "unused" })
	@Override
    public Map<String, Object> listwebResheetDetail(CommandMap commandMap)  throws Exception {
        Map<String, Object> resultMap = new HashMap<String,Object>();
        try {
            SimpleDateFormat formatter = new SimpleDateFormat("yyyy.MM", Locale.KOREA);
            Calendar cal = Calendar.getInstance();
            ...
            dataMap =  webDAO.listwebResheetDetail(commandMap.getMap());
            List<webVO> listParam = (List<webVO>) dataMap.get("datalist");
     ...
     * ******************************************************************************************* */
    @Override
    public Map<String, Object> detailweb(CommandMap commandMap)  throws Exception {
        Map<String, Object> resultMap = new HashMap<String,Object>();
        try {
            webVO detailParam = new webVO();
            detailParam = webDAO.detailweb(commandMap.getMap());

            //jsp 에서 보여줄 정보 추출
            resultMap.put("webDetail", detailParam); //내용
        }
        catch(Exception e){
            log.error(e.toString());
            throw e;
     ...
     * ******************************************************************************************* */
    @Override
    public int totalCountweb(CommandMap commandMap) throws Exception {
        return webDAO.totalCountweb(commandMap.getMap());
    }
     ...
     * ******************************************************************************************* */
    @Override
    public int overlabCountweb(CommandMap commandMap) throws Exception {
        return webDAO.overlabCountweb(commandMap.getMap());
    }
     ...
     * ******************************************************************************************* */
    @Override
    public Map<String, Object> overlabListweb(CommandMap commandMap)  throws Exception {
        Map<String, Object> resultMap = new HashMap<String,Object>();
        try {
            List<webVO> listParam = webDAO.overlabListweb(commandMap.getMap());
     ...
     * ******************************************************************************************* */
    @Override
    public Map<String, Object> insertweb(CommandMap commandMap) throws Exception {
        Map<String, Object> resultMap = new HashMap<String,Object>();
        try {
            int overlab = webDAO.overlabCountweb(commandMap.getMap());
            if (overlab != 0) {
            	
				 	int process = webDAO.updateweb(commandMap.getMap());
					if (process > 0) {
     ...
     * ******************************************************************************************* */
    @Override
    public Map<String, Object> updateweb(CommandMap commandMap) throws Exception {
        Map<String, Object> resultMap = new HashMap<String,Object>();
        try {
            int overlab = webDAO.overlabCountweb(commandMap.getMap());
            if (overlab == 0) {
                int process = 0;
                process += webDAO.updateweb(commandMap.getMap());
     ...
     * ******************************************************************************************* */
    @Override
    public Map<String, Object> updatewebRecive(CommandMap commandMap) throws Exception {
        Map<String, Object> resultMap = new HashMap<String,Object>();
        try {
            int process = 0;
            ...
            process += webDAO.multiUpdateShippingRecive(commandMap.getMap());
            process += webDAO.updatewebRecive(commandMap.getMap());
     ...
     * ******************************************************************************************* */
    @Override
    public Map<String, Object> deleteweb(CommandMap commandMap) throws Exception {
        Map<String, Object> resultMap = new HashMap<String,Object>();
        try {
            commandMap.put("nCurrpage", "1");
            int process = 0;
            process = webDAO.deletewebShipping(commandMap.getMap());
            process = webDAO.deleteweb(commandMap.getMap());
            if (process == 1) {
                resultMap.put("status", 0);
    ...
    public Map<String, Object> detailMaterialNum(CommandMap commandMap)  throws Exception {
        ...
        try {
            ...
            detailParam = webDAO.detailMaterialNum(commandMap.getMap());
            //jsp 에서 보여줄 정보 추출
	...
	@SuppressWarnings("unchecked")
	@Override
    public Map<String, Object> listwebHistory(CommandMap commandMap)  throws Exception {
        Map<String, Object> resultMap = new HashMap<String,Object>();
        try {
        	Map<String, Object> dataMap = new HashMap<String,Object>();
        	
            dataMap =  webDAO.listwebHistory(commandMap.getMap());
            List<webVO> listParam = (List<webVO>) dataMap.get("datalist");
            resultMap.put("webList", listParam); //목록
        }
        catch(Exception e){
