...
@Service("ReissueDeliveryDocService")
public class ReissueDeliveryDocServiceImpl implements ReissueDeliveryDocService {

    // 쿼리로그 추출
	Logger log = LoggerFactory.getLogger(this.getClass());

    @Resource(name="ReissueDeliveryDocDAO")
    private ReissueDeliveryDocDAO ReissueDeliveryDocDAO;
    ...
    public Map<String, Object> listDeliveryDoc(CommandMap commandMap)  throws Exception {
        ...
        try {
            ...
            Map<String, Object> dataMaterialMap =  ReissueDeliveryDocDAO.listMaterialNum(commandMap.getMap());
            ...
            dataMap =  ReissueDeliveryDocDAO.listReissueDeliveryDoc(commandMap.getMap());
    ...
    /* *******************************************************************************************
     * 함수  제목 :  
     * 작  성  자 :       작  성  일 : 2020-04-28
     * 내      용 :  
     * 수  정  자 :             수  정  일 :
     * 수정  내용 :
     * ******************************************************************************************* */
    @Override
    public Map<String, Object> useInfoList(CommandMap commandMap)  throws Exception {
        Map<String, Object> resultMap = new HashMap<String,Object>();
      
        try {
            List<ReissueDeliveryDocVO> listParam = ReissueDeliveryDocDAO.useInfoList(commandMap.getMap());

            JSONObject pageParam = StringUtil.getJsonStringFromMap(commandMap.getMap());

            //jsp 에서 보여줄 정보 추출
            resultMap.put("pageParam", pageParam); //변수값
            resultMap.put("userInfo", listParam); //목록
        }
        catch(Exception e){
            log.error(e.toString());
            throw e;
     ...
     * ******************************************************************************************* */
    @Override
    public Map<String, Object> DeliveryDocList(CommandMap commandMap)  throws Exception {
        Map<String, Object> resultMap = new HashMap<String,Object>();
      
        try {
            List<ReissueDeliveryDocVO> listParam = ReissueDeliveryDocDAO.DeliveryDocList(commandMap.getMap());
    ...
    public Map<String, Object> listDeliveryDocConfirm(CommandMap commandMap)  throws Exception {
        ...
        try {
            ...
            Map<String, Object> dataMaterialMap =  ReissueDeliveryDocDAO.listMaterialOrderAll(commandMap.getMap());
            List<MeterialNumVO> listMaterialParam = (List<MeterialNumVO>) dataMaterialMap.get("materiallist");

            dataMap =  ReissueDeliveryDocDAO.listReissueDeliveryDocConfirm(commandMap.getMap());
            List<DeliveryDocVO> listParam = (List<DeliveryDocVO>) dataMap.get("datalist");
    ...
    public Map<String, Object> listDeliveryDocResheet(CommandMap commandMap)  throws Exception {
        ...
        try {
            ...
            dataMap =  ReissueDeliveryDocDAO.listReissueDeliveryDocResheet(commandMap.getMap());
            List<DeliveryDocVO> listParam = (List<DeliveryDocVO>) dataMap.get("datalist");
    ...
    public Map<String, Object> listDeliveryDocResheetDetail(CommandMap commandMap)  throws Exception {
        ...
        try {
            ...
            dataMap =  ReissueDeliveryDocDAO.listReissueDeliveryDocResheetDetail(commandMap.getMap());
            List<DeliveryDocVO> listParam = (List<DeliveryDocVO>) dataMap.get("datalist");
    ...
    public Map<String, Object> detailDeliveryDoc(CommandMap commandMap)  throws Exception {
        ...
        try {
            ...
            detailParam = ReissueDeliveryDocDAO.detailDeliveryDoc(commandMap.getMap());
    ...
    public int totalCountDeliveryDoc(CommandMap commandMap) throws Exception {
        return ReissueDeliveryDocDAO.totalCountDeliveryDoc(commandMap.getMap());
    }
    ...
    public int overlabCountDeliveryDoc(CommandMap commandMap) throws Exception {
        return ReissueDeliveryDocDAO.overlabCountDeliveryDoc(commandMap.getMap());
    }
    ...
    public Map<String, Object> overlabListDeliveryDoc(CommandMap commandMap)  throws Exception {
        Map<String, Object> resultMap = new HashMap<String,Object>();
        try {
            List<DeliveryDocVO> listParam = ReissueDeliveryDocDAO.overlabListDeliveryDoc(commandMap.getMap());
    ...
    public Map<String, Object> insertDeliveryDoc(CommandMap commandMap) throws Exception {
		...
		try {
			...
			int process = ReissueDeliveryDocDAO.insertDeliveryDoc(commandMap.getMap());
			if (process > 0) {
    ...
    public Map<String, Object> updateDeliveryDoc(CommandMap commandMap) throws Exception {
        ...
        try {
			...
			ReissueDeliveryDocDAO.listReissueDeliveryDocDelvn(commandMap.getMap());
			...
			for (int n = 0; n < DeliveryDocArray.length; n++) {
				...
				map.put("doc_delvs", 		array[1]);	
				map.put("doc_ebeln", 		array[2]);	
				map.put("doc_ebelp", 		array[3]);	
				map.put("doc_menge", 		array[4]);		//납품수량
				map.put("MengeToStatu", 	array[5]);		//남은수량
				map.put("doc_ebeln_menge", 	array[6]);	  	//납품예정수량
				...
				if(array[0].equals("")) {
					process += ReissueDeliveryDocDAO.multiUpdateReissueDeliveryDoc(commandMap.getMap());
				} else {
					process += ReissueDeliveryDocDAO.multiUpdateReissueDeliveryDoc_Cancel(commandMap.getMap());
				}
			}
    ...
    public Map<String, Object> updateDeliveryDocRecive(CommandMap commandMap) throws Exception {
        ...
        try {
            ...
            process += ReissueDeliveryDocDAO.multiUpdateShippingRecive(commandMap.getMap());
            process += ReissueDeliveryDocDAO.updateDeliveryDocRecive(commandMap.getMap());
    ...
    public Map<String, Object> deleteDeliveryDoc(CommandMap commandMap) throws Exception {
        ...
        try {
            ...
            int process = 0;
            process = ReissueDeliveryDocDAO.deleteDeliveryDocShipping(commandMap.getMap());
            process = ReissueDeliveryDocDAO.deleteDeliveryDoc(commandMap.getMap());
            if (process == 1) {
                resultMap.put("status", 0);
    ...
    public Map<String, Object> detailMaterialNum(CommandMap commandMap)  throws Exception {
        ...
        try {
            ...
            detailParam = ReissueDeliveryDocDAO.detailMaterialNum(commandMap.getMap());
            //jsp 에서 보여줄 정보 추출
    ...
    public Map<String, Object> listDeliveryDocHistory(CommandMap commandMap)  throws Exception {
        ...
        try {
            ...
            dataMap =  ReissueDeliveryDocDAO.listReissueDeliveryDocHistory(commandMap.getMap());
            List<DeliveryDocVO> listParam = (List<DeliveryDocVO>) dataMap.get("datalist");
            resultMap.put("DeliveryDocList", listParam); //목록
        }
        catch(Exception e){
