                    ...
                    <div class="listleft">
                        ...
                        <div class="bbsL_box">
                            ...
                            <div class="bbsB ta_r mt_10">
                                <ul class="btn_all">
                                    <li class="li_right" ><span class="button medium"><a href="javascript:void(0)" id="mtmExcel">목록엑셀다운</a></span>&nbsp;&nbsp;</li>
                                </ul>
                            </div>
                        </div>
                        <!-- //내용 -->
    ...
    $(document).ready(function() {
        ...
        $('#searchBtn').on("click", function(e){
            ...
            if ("${userRole}" == "ADMIN") {
                ...
                comSubmit.setUrl("/shipping/mtmlist");
            }
            comSubmit.submit();
        });
        ...
        $('#mtmExcel').on('click', function() {
            var comSubmit = new ComSubmit("searchForm");
            comSubmit.setUrl("/shipping/mtmlistExcel");
            comSubmit.submit();
