                ...
                <div id="content_pop">
                    <div class="bbsL_box">
                        ...
                        <table cellspacing="0" border="1" summary="목록정보" cellpadding="0" class="bbsL">
                            ...
                            <tr>
                                <th scope="col" class="ta_c">자재코드</th>
                                <th scope="col" class="ta_c">저장위치</th>
                                <th scope="col" class="ta_c">수량</th>
                            </tr>
                            </thead>
                            <tbody>
                            <c:forEach var="result" items="${shippingMaterialList}" varStatus="status">
                                <tr>
