...
<%
    String localPageTitle = " > 납품문서처리 확정";
                                    ...
                                    <table class="bbsCom_WRITE">
                                        ...
                                        <tbody>
                                         ...
                                         <tr>
                                            ...
                                            <td><input type="text" maxlength="15" id="DeliveryDoc_EBELN" name="DeliveryDoc_EBELN" size="12" class="input_s1 ta_r" readonly /></td>
                                        </tr>
                                         <tr>
                                            <th scope="row" style="font-size:12px" class="ta_r"> 구매오더 품목번호</th>
                                            <td><input type="text" maxlength="10" id="DeliveryDoc_EBELP" name="DeliveryDoc_EBELP" size="12" class="input_s1 ta_r" readonly/></td>
                                        </tr>
                                         <tr>
                                            <th scope="row" style="font-size:12px" class="ta_r"> 자재번호</th>
                                            <td><input type="text" maxlength="10" id="DeliveryDoc_MATNR" name="DeliveryDoc_MATNR" size="12" class="input_s1 ta_r" readonly/></td>
                                        </tr>
                                         <tr>
                                            <th scope="row" style="font-size:12px" class="ta_r"> 자재내역</th>
                                            <td><input type="text" maxlength="10" id="DeliveryDoc_TXZ01" name="DeliveryDoc_TXZ01" size="12" class="input_s1 ta_r" readonly/></td>
                                        </tr>
                                         <tr>
                                            <th scope="row" style="font-size:12px" class="ta_r"> 발주수량</th>
                                            <td><input type="text" maxlength="10" id="DeliveryDoc_ebeln_menge" name="DeliveryDoc_ebeln_menge" size="12" class="input_s1 ta_r" readonly/></td>
                                        </tr>
                                         <tr>
                                            <th scope="row" style="font-size:12px" class="ta_r"> 단위</th>
                                            <td><input type="text" maxlength="10" id="DeliveryDoc_MEINS" name="DeliveryDoc_MEINS" size="12" class="input_s1 ta_r" readonly/></td>
                                        </tr>
                                         <tr>
                                            <th scope="row" style="font-size:12px" class="ta_r"> 납품예정일</th>
                                            <td><input type="text" maxlength="10" id="DeliveryDoc_EINDT" name="DeliveryDoc_EINDT" size="12" class="input_s1 ta_r" readonly/></td>
                                        </tr>
                                         <tr>
                                           <th scope="row" style="font-size:12px" class="ta_r"> 납품예정수량</th>
                                            <td><input type="text" maxlength="10" id="DeliveryDoc_END_MENGE" name="DeliveryDoc_END_MENGE" size="12" class="input_s1 ta_r" readonly/></td>
                                        </tr>
                                         <tr>
                                            <th scope="row" style="font-size:12px" class="ta_r"> 총 납품수량</th>
                                          	<td><input type="text" maxlength="10"  id="DeliveryDoc_MENGE_tot" name="DeliveryDoc_MENGE_tot" size="12" class="input_s1 ta_r" value='' readonly></td>
                                        </tr>
                                        
                                         <tr>
                                            <th scope="row" style="font-size:12px" class="ta_r"> 납품수량</th>
                                          	<td><input style="background-color:orange" maxlength="10" type="text" id="DeliveryDoc_ibgo_menge" name="DeliveryDoc_ibgo_menge" size="12" class="input_s1 ta_r" value='' ></td>
                                        </tr>
                                          <tr>
                                            <th scope="row" style="font-size:12px" class="ta_r"> 납품일</th>
                                            <td><input maxlength="10" type="text" id="DeliveryDoc_NAP_PRE_DT" name="DeliveryDoc_NAP_PRE_DT" size="12" class="input_s1 ta_r" value='' readonly></td>
                                        </tr>
                                        
                                                           
                                        <tr id="btndiv">
                                            <td class="ta_c" style="border-left:1px solid #e0e0e0;height:30px;background:#000000;" colspan="2">
                                                <div id="btndiv1" style="display:none;display: inline-block;"><input type="radio" id="rtoCfr" name="rtogubun" value="OFR" /><label for="rtoCfr"><span style="color:white">납품확정</span></label>&nbsp;</div>
                                        </td>
                                        

                                        </tbody>
                                        <tr>
                                          	<!-- <th scope="row" style="font-size:12px" class="ta_r"> 생성인</th> -->
                                            <td><input type="text" style="display:none;"maxlength="10" id="DeliveryDoc_UNAME" name="DeliveryDoc_UNAME" size="12" class="input_s1 ta_r" readonly/></td>
                                        </tr>
                                        <tr>
                                          	<!-- <th scope="row" style="font-size:12px" class="ta_r"> 생성인ID</th> -->
                                            <td><input type="text" style="display:none;"maxlength="10" id="DeliveryDoc_FIN_ID" name="DeliveryDoc_FIN_ID" size="12" class="input_s1 ta_r" readonly/></td>
                                        </tr>
                                        <tr>
                                          	<!-- <th scope="row" style="font-size:12px" class="ta_r"> 클라이언트</th> -->
                                            <td><input type="text" style="display:none;"maxlength="10" id="DeliveryDoc_MANDT" name="DeliveryDoc_MANDT" size="12" class="input_s1 ta_r" readonly/></td>
                                        </tr>
                                        <tr>
                                          	<!-- <th scope="row" style="font-size:12px" class="ta_r"> 공급업체</th> -->
                                            <td><input type="text" style="display:none;"maxlength="10" id="DeliveryDoc_LIFNR" name="DeliveryDoc_LIFNR" size="12" class="input_s1 ta_r" readonly/></td>
                                        </tr>
                                        <tr>
                                          <!-- 	<th scope="row" style="font-size:12px" class="ta_r"> 잔고</th> -->
                                            <td><input type="text" style="display:none;"maxlength="10" id="DeliveryDoc_ibgo_menge_r" name="DeliveryDoc_ibgo_menge_r" size="12" class="input_s1 ta_r" readonly/></td>
                                        </tr>
                                        <tr>
                                          	<!-- <th scope="row" style="font-size:12px" class="ta_r"> 납품문서 번호</th> -->
                                            <td><input type="text" style="display:none;" maxlength="10" id="DeliveryDoc_DELVN" name="DeliveryDoc_DELVN" size="12" class="input_s1 ta_r" readonly/></td>
                                        </tr>         
                                         <tr>
                                          <!-- 	<th scope="row" style="font-size:12px" class="ta_r"> 납품문서 항목 번호</th> -->
                                            <td><input type="text" style="display:none;"maxlength="10" id="DeliveryDoc_DELVS" name="DeliveryDoc_DELVS" size="12" class="input_s1 ta_r" readonly/></td>
                                        </tr>    
                                         <tr>
                                            <!-- <th scope="row" style="font-size:12px" class="ta_r" > 입고수량</th> -->
                                          	<td><input maxlength="10" type="text" style="display:none;" id="DeliveryDoc_MENGE" name="DeliveryDoc_MENGE" size="12" class="input_s1 ta_r" value='' readonly ></td>
                                        </tr>
                                    </table>
                                </div>
                            </form>
                        ...
                        <div class="bbsL_box">
                            ...
                            <div class="bbsCom_TOP">
                                <form id="searchForm" name="searchForm">
                                    ...
                                    <fieldset>
                                    	...
                                    	<%-- <input size="10" maxlength="8" type="text" id="order_dt_start" name="order_dt_start"  style="display:none" value='${pageParam.order_dt_start}' > ~
                                    	<input size="10" maxlength="8" type="text" id="order_dt_end" name="order_dt_end"  style="display:none" value='${pageParam.order_dt_end}' > --%>
                                   		<input type="button"  value="납품문서 처리" id="searchBtn1" class="btn_schok" /> 
                                   		<label style="font-size:15px;font-weight:bold">구매오더번호 : </label>
                                		...
                                		<input type="image" src="/images/board/btn_schok.gif"  id="searchBtn" alt="검색" title="검색" class="btn_schok" />
	 									<!-- 
	 									<input type="button"  value="납품문서 재발행" id="searchBtn2" class="btn_schok" /> 
                            ...
                            <table cellspacing="0" border="1" summary="목록정보"  cellpadding="0" id="tbllist" class="bbsCom2">
                                ...
                                <colgroup>
                                	<col width="50" />    	<!-- 확인 -->
                               		 <!-- 	
                                	<col width="130px" />   납품문서 번호
                                    <col width="100px" />	납품문서 항목번호
                                     -->
                                    <col width="100px" />   <!-- 구매오더번호 -->
                                    <col width="50px" />	<!-- 품목번호 -->
                                ...
                                <tr>
                                	...
                                	<th scope="col" class="ta_r" style="display:none">납품문서번호</th>
                                	<th scope="col" class="ta_r" style="display:none">번호(납품)</th>
                                   	<th scope="col" class="ta_l">구매오더번호</th>
                                    <th class="ta_c" scope="col">품번</th>
                                ...
                                <c:forEach var="result" items="${DeliveryDocList}" varStatus="status">
                                    <tr class="row" >
                                     ...
                                     <td nowrap="nowrap" >
                                    <c:choose>
                                        <c:when test = "${result.DELVS == 'A'}">
                                            <input type="checkbox"  id="checkOne${status.count}" checked name="checkOne" class="checkBtn" value="${result.DELVN}:${result.DELVS}:${result.EBELN}:${result.EBELP}:${result.MENGE}:${result.ibgo_menge}">
                                        </c:when>
                                        <c:otherwise>
                                              <input type="checkbox"  id="checkOne${status.count}"  name="checkOne" class="checkBtn" value="${result.DELVN}:${result.DELVS}:${result.EBELN}:${result.EBELP}:${result.MENGE}:${result.ibgo_menge}">
                                        </c:otherwise>
                                    </c:choose>
                                     </td>    

                                     <!-- <th class="col ord ta_l"><input name="checkAll" class="checkBtn" id="checkAll" type="checkbox" ></th> -->
                                     <td class="col ord ta_l"style="display:none"><c:out value="${result.DELVN}"  default=""/></td>  	<!-- 납품문서 번호 -->
                                     <td class="col ord ta_l"style="display:none"><c:out value="${result.DELVS}"  default=""/></td>  	<!-- 납품문서 항목번호 -->
                                     <td class="col ord ta_l"><c:out value="${result.EBELN}"  default=""/></td>  	<!-- 구매오더번호 -->
                                     <td class="col ord ta_l"><c:out value="${result.EBELP}"  default=""/></td>  	<!-- 품목번호 -->
                                     ...
                                     <td class="col ord ta_l"><fmt:parseDate value="${result.NAP_PRE_DT}" var="aHms" pattern="yyyyMMdd"/> <!-- 납품예정일-->
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#DeliveryDoc").attr('class', 'current');
        ...
        $("a[name = 'pageMove']").unbind("click").click(function(e) {
            ...
            comSubmit.setUrl("/web/DeliveryDoc");
     ...
     /*  납품문서 처리*/
         $('#searchBtn1').click(function() {
             ...
             if(tmp.indexOf("::") >= 0){
         		 alert("납품 확정을 안한 항목이 포함되어 있습니다. 항목을 확인해 주세요!");
         		return ;
         	}  
...
/* 
         ...
         $('#searchBtn3').click(function() {
             ...
             if(tmp.indexOf("::") >= 0){
         		 alert("납품문서 처리가 안된 항목이 포함되어 있습니다.");
         		return ;
         	}
        ...
        $('#supplyRegister').click(function() {
        	...
        	var rtogubun;
        	   ...
        	   if (Number($('#DeliveryDoc_ibgo_menge_r').val().replace(",","")) < Number($('#DeliveryDoc_ibgo_menge').val().replace(",",""))){
           		  alert("발주수량 보다 많습니다");
           	   	  $("#DeliveryDoc_ibgo_menge").focus()
           		  return;
           	  } 
